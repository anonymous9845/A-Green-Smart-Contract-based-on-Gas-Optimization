...
contract Store is Owned, SafeMath {
    ...
    */
    ...
    /**
          ...
          @return success
    */
    function registerProduct(uint256 id, bytes32 name, bytes32 description, uint256 price, uint256 default_amount) onlyOwner returns (bool success) {
    ...
    */
    ...
    /**
          ...
          @return success
    */
    function registerCustomer(address _address, bytes32 _name, uint256 _balance) onlyOwner returns (bool success) {
    ...
    /**
        ...
        @return success
    */
    function deregisterCustomer(address _address) onlyOwner returns (bool success) {
    ...
    */
    function insertProductIntoCart(uint256 id) returns (bool success, uint256 pos_in_prod_mapping) {
    ...
    */
    ...
    /**
          ...
          @return success
    */
    function renameStoreTo(bytes32 new_store_name) onlyOwner returns (bool success) {
    ...
    */
    function getProduct(uint256 id) constant returns (bytes32 name, bytes32 description, uint256 price, uint256 default_amount) {
    ...
    */
    function getCart() constant returns (uint256[] memory product_ids, uint256 complete_sum) {
      Customer customer = customers[msg.sender];
